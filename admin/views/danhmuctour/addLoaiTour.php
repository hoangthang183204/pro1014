              ...
              <div class="container mt-4">
                  ...
                  <div class="card">
                      <div class="card-header">
                          <h5 class="mb-0"><i class="fas fa-info-circle me-2"></i>Thông tin loại tour</h5>
                      </div>
                      <div class="card-body">
                          <form method="POST" action="?act=danh-muc-loai-tour-store">
                              <div class="row">
                                  <div class="col-md-12">
                                      <div class="mb-3">
                                          ...
                                          <input type="text" name="ten_loai" class="form-control" required
                                              placeholder="VD: Tour Du Lịch Nghỉ Dưỡng, Tour Khám Phá...">
                                      </div>
                                  </div>
                              </div>
                              ...
                              <div class="mb-3">
                                  ...
                                  <textarea name="mo_ta" class="form-control" rows="4"
                                      placeholder="Mô tả về loại tour, đặc điểm..."></textarea>
                              </div>
                              ...
                              <div class="d-flex justify-content-between">
                                  ...
                                  <button type="submit" class="btn btn-success">
                                      <i class="fas fa-save me-1"></i> Lưu Loại Tour
                                  </button>
                              </div>
                          </form>
                      </div>
